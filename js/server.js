  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      for (var i = 0; i < res.length; i++) {
        ...
        row.append(
          $(
            "<td><button class='btn btn-danger' onclick='item_dele(" +
              item.id +
              ")'style='padding-left: 17px ;padding-right: 17px;float: right;'><span class='far fa-trash-alt'></span></button> <button class='btn btn-secondary' onclick='item_edit(" +
              item.id +
              ")'style='padding-left: 16px ;padding-right: 16px;padding-top: 15px ;padding-bottom: 15px ;float: right;'><span class='fas fa-edit'></span></button> <button class='btn btn-success' onclick='btn_save_click()(" +
              item.id +
              ")'style='padding-left: 17px ;padding-right: 17px;float: right;'><span class='fas fa-save'></span></button></td>"
          )
        );
        table.append(row);
      }
